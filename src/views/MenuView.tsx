    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl border border-gray-100 overflow-hidden shadow-sm">
                ...
                <button onClick={() => setView('installments')} className="w-full flex items-center justify-between p-4 bg-white border-b border-gray-100 active:bg-gray-50 hover:bg-gray-50 transition-colors"><div className="flex items-center gap-3"><Icon name="credit_card" className="text-teal-500 bg-teal-50 p-1.5 rounded-lg"/><span className="font-bold text-dark">分期付款追蹤 <span className="ml-1 text-[10px] bg-red-100 text-red-500 px-1 py-0.5 rounded">NEW</span></span></div><Icon name="chevron_right" className="text-gray-300" size="text-xl"/></button>
